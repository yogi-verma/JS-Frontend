    ...
    <>
      ...
      >
        <div className="flex-1 min-w-0">
          ...
          <p className={`text-xs mt-0.5 truncate ${user.company ? (isDark ? "text-gray-200" : "text-gray-900") : (isDark ? "text-gray-600" : "text-gray-400")}`}>
        ...
        <div className="fixed inset-0 z-60 flex items-center justify-center p-4">
          ...
          >
            <div className="px-5 py-3 flex items-center justify-between" style={{ borderBottom: `1px solid ${isDark ? "#21262D" : "#D0D7DE"}` }}>
              <h2 className={`text-base font-semibold ${isDark ? "text-gray-100" : "text-gray-900"}`}>Edit company</h2>
            ...
            <div className="p-5">
              <label htmlFor="editCompany" className={`block text-sm font-medium mb-2 ${isDark ? "text-gray-300" : "text-gray-700"}`}>
                Company
              </label>
              <input
                id="editCompany"
